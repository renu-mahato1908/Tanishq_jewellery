                    ...
                    <Row>
                        ...
                        <Col  md={4}>
                            <div className="polaroid">
                                ...
                                <div className="details">
                                    <h5>Delicate Details Gold Finger Ring</h5>
                                    <h4>₹13916</h4>
                                </div>
                                <button>
                                    <h5>Buy now</h5>
                        ...
                        <Col  md={4}>
                            <div className="polaroid">
                                ...
                                <div className="details">
                                    <h5>Sculpted Grace Diamond Finger Ring</h5>
                                    <h4>₹ 38168</h4>
                                </div>
                                <button>
                                    <h5>Buy now</h5>
                        ...
                        <Col  md={4}>
                            <div className="polaroid">
                                ...
                                <div className="details">
                                    <h5>Dazzling Halo Diamond Finger Ring</h5>
                                    <h4>₹50735 </h4>
                                </div>
                                <button>
                                    <h5>Buy now</h5>
                    ...
                    <Row>
                        <Col  md={4}>
                            <div className="polaroid">
                                ...
                                <div className="details">
                                    <h5>Timeless Blossom Diamond Finger Ring</h5>
                                    <h4>₹30925</h4>
                                </div>
                                <button>
                                    <h5>Buy now</h5>
                        ...
                        <Col  md={4}>
                            <div className="polaroid">
                                ...
                                <div className="details">
                                    <h5>Intricate Gold Finger Ring</h5>
                                    <h4>₹83220</h4>
                                </div>
                                <button>
                                    <h5>Buy now</h5>
                        ...
                        <Col  md={4}>
                            <div className="polaroid">
                                ...
                                <div className="details">
                                    <h5>Modish Links Diamond Ring</h5>
                                    <h4>₹43592</h4>
                                </div>
                                <button>
                                    <h5>Buy now</h5>
                    ...
                    <Row>
                        <Col  md={4}>
                            <div className="polaroid">
                                ...
                                <div className="details">
                                    <h5>Classic 22 Karat Yellow Gold Leaf Patterned Finger Ring</h5>
                                    <h4>₹56668</h4>
                                </div>
                                <button>
                                    <h5>Buy now</h5>
                        ...
                        <Col  md={4}>
                            <div className="polaroid">
                                ...
                                <div className="details">                                   
                                     <h5>Stellar Embrace Solitaire Ring</h5>
                                    <h4>₹217316</h4>
                                </div>
                                <button>
                                    <h5>Buy now</h5>
                        ...
                        <Col  md={4}>
                            <div className="polaroid">
                                ...
                                <div className="details">
                                    <h5>Regal Aura Solitaire Ring for Men</h5>
                                    <h4>₹164943</h4>
                                </div>
                                <button>
                                    <h5>Buy now</h5>
                    ...
                    <Row>
                        <Col  md={4}>
                            <div className="polaroid">
                                ...
                                <div className="details">
                                    <h5>Spiral Sparkle Diamond Ring</h5>
                                    <h4>₹90080</h4>
                                </div>
                                <button>
                                    <h5>Buy now</h5>
                        ...
                        <Col  md={4}>
                            <div className="polaroid">
                                ...
                                <div className="details">
                                    <h5>Forever Arc Solitaire Ring for Men</h5>
                                    <h4>₹119541</h4>
                                </div>
                                <button>
                                    <h5>Buy now</h5>
                        ...
                        <Col  md={4}>
                            <div className="polaroid">
                                ...
                                <div className="details">
                                    <h5>Aurora Bloom Diamond Rings</h5>
                                    <h4>₹56870</h4>
                                </div>
                                <button>
                                    <h5>Buy now</h5>
