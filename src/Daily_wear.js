                    ...
                    <Row>
                        ...
                        <Col  md={4}>
                            <div className="product">
                                ...
                                <Image src='https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwd49a2679/images/hi-res/516061VAG1A00_1.jpg?sw=640&sh=640' thumbnail></Image>
                                <div className="detail">

                                    <h5>Everlasting Grace Bangle
                                    </h5>
                                    <h4>₹122945</h4>
                                </div>
                                                                <button>Buy now</button>
                    ...
                    <Row>
                        ...
                        <Col  md={4}>
                            <div className="product">
                                ...
                                <Image src='https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwd28b8c9f/images/hi-res/5923GIJ_1.jpg?sw=480&sh=480' thumbnail></Image>
                                <div className="detail">

                                    <h5>Heart of Amethyst 14 Kt Gold Chain
                                    </h5>
                                    <h4>₹22995</h4>
                                </div>
                                                                <button>Buy now</button>
                    ...
                    <Row>
                        ...
                        <Col  md={4}>
                            <div className="product">
                                ...
                                <div className="detail">
                                    ...
                                    <h5>Arresting Leaf Motif Diamond Pendant
                                    </h5>
                                    <h4>₹19890</h4>
                                </div>
                                                                <button>Buy now</button>
                        ...
                        <Col  md={4}>
                            <div className="product">
                                ...
                                <Image src='https://www.tanishq.co.in/dw/image/v2/BKCK_PRD/on/demandware.static/-/Sites-Tanishq-product-catalog/default/dwf9c8c1e4/images/hi-res/2822HTZ.jpg?sw=640&sh=640' thumbnail></Image>
                                <div className="detail">

                                    <h5>22KT Yellow Gold  Earrings
                                    </h5>
                                    <h4>₹69758</h4>
                                </div>
                                <button>Buy now</button>
